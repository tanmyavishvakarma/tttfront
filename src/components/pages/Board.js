...
import qs from 'qs'
const ENDPOINT = 'https://ttttback.onrender.com/'
    ...
    if (this.state.joinError){
      ...
      return(
        <>
          ...
          <div  style={{fontSize:"20px"}}>Game with {this.state.opponentPlayer[0]}</div>
         <br></br>
          <div  style={{fontSize:"15px"}}> Your Piece</div>
          <div style={{ fontSize:"25px",color: this.state.piece!== 'X'? 'red': 'blue'}}>{this.state.piece}</div>
